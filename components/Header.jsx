...
const Header = () => {
    ...
    useEffect(() => {
        ...
        console.log('activeNestedDropdown', activeNestedDropdown);

    }, [activeDropdown, activeNestedDropdown]);
