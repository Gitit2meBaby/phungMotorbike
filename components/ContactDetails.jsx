    ...
    return (
        <section className={styles.details}>
            ...
            <div className={styles.contact}
                ...
                <p>13 Ngo Huyện, Hàng Trống, Hoàn Kiếm, Hà Nội
                </p>
            </div>

            <div className={styles.contact}
                onClick={() => window.open('tel:+84965936677')}>
            ...
            <div className={styles.contact}
                onClick={() => window.open('https://wa.me/84904253491')}>
            ...
            <div className={styles.contact}
                onClick={() => window.open('mailto:2wheelsvietnam@gmail.com')}>
            ...
            <a style={{ textDecoration: 'none' }} href="https://www.facebook.com/PhungMotorbike?ref=embed_page" target="_blank" rel="noopener noreferrer">
                <div className={styles.contact}>
