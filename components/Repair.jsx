...
const Repair = () => {
    return (
        <section className={styles.repair}>
            ...
            <p>If you need a general checkup, we will have a test drive on you bike then tell you what should be done, how much it may cost, and if you agree with the cost, we will start to work on your bike.</p>
